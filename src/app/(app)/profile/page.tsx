    ...
    <div className="max-w-2xl">
      ...
      <Card className="mt-6">
        ...
        <form action={updateProfile} className="space-y-4">
          ...
          <label className="block text-sm font-medium">생년월일<Input name="birthDate" type="date" defaultValue={user.birthDate ? formatDateOnly(user.birthDate) : ""} required className="mt-2" />{user.birthDate && <span className="mt-1 block text-xs font-normal text-slate-500">현재 만 {calculateAge(user.birthDate)}세</span>}</label>
