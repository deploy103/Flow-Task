import { Building2, Home, LogOut, UserRound } from "lucide-react";
...
export function AppShell({
  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[240px_1fr]">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-20 grid grid-cols-3 border-t border-slate-200 bg-white px-2 py-2 dark:border-slate-800 dark:bg-slate-950 lg:hidden">
        {navigation.map(({ href, label, icon: Icon }) => (
